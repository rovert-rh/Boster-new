...
const Hero = () => {
    ...
    return (
        <div className="bg-center h-screen relative">
            ...
            <div className="bg-cover bg-no-repeat lg:bg-transparent z-10 top-0 left-0 w-screen h-full flex items-center justify-center md:justify-between bg-center bg-[url('/src/assets/home.png')]">
